...
class Client():
    def __init__(self, H=None, p=None, i=None, e=None, t=None, s=None, d=None, vision=False):
        ...
        self.step_count = 0
        telemetry_dir = r"C:\Users\augus\SynologyDrive\Documents\ESILV\Ved\torcs"
        telemetry_path = os.path.join(telemetry_dir, "telemetry.csv")
        ...
        try:
            self.log_file = open(telemetry_path, "w")
            self.log_file.write("step,speedX,targetSpeed,trackPos,angle,steer,accel,brake,slip,skid,gear,rpm,steer_anticipation,steer_pos,steer_angle\n")
            print(f"Télémétrie activée dans : {telemetry_path}")
        except Exception as e:
            print(f"Erreur d'ouverture du fichier log : {e}")
    ...
    def get_servers_input(self):
        ...
        while True:
            ...
            if '***identified***' in sockdata:
                ...
                print("Server has stopped the race on %d. You were in %d place." %
...
class ServerState():
    ...
    def fancyout(self):
        out = str()
        sensors = ['stucktimer', 'fuel', 'distRaced', 'distFromStart', 'opponents', 'wheelSpinVel', 'z', 'speedZ', 'speedY', 'speedX', 'targetSpeed', 'rpm', 'skid', 'slip', 'track', 'trackPos', 'angle']
        for k in sensors:
            if type(self.d.get(k)) is list:
                ...
                if k == 'gear':
                    ...
                    slip = 0
                    if frontwheelradpersec:
                        slip = ((self.d['wheelSpinVel'][2] + self.d['wheelSpinVel'][3]) - (self.d['wheelSpinVel'][0] + self.d['wheelSpinVel'][1]))
